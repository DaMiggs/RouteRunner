...
public class Caravans extends Vehicles {
   ...
   /* private ArrayList<String> Caravan1 = new ArrayList<>();
    ...
    public ArrayList<Integer> sortedCaravan1 = new ArrayList<>();
    public ArrayList<Integer> sortedCaravan2 = new ArrayList<>();
    public ArrayList<Integer> sortedCaravan3 = new ArrayList<>();
    public int newDay = 0;
    public int dayCaravan=0;
